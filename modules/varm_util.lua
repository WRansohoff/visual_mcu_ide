...
-- (Common multi-part includes.)
-- Ensure that common I2C communications methods are included.
...
-- Ensure that 'Data/Command'-style I2C communications methods are included.
...
-- Ensure that 'draw framebuffer' methods and globals are included.
function varm_util.ensure_ssd1306_fb_included(node_code_path, proj_state)
  local util_s_insert_path = node_code_path .. 'src/util_S.insert'
